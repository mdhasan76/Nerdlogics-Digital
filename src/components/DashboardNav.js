...
const DashboardNav = () => {
    ...
    return (
        <div>
        <button onClick={() => setToggle(!toggle)} className='sm:hidden block p-5 bg-green-400 rounded-lg text-lg'> click me</button>
            <div className={`sm:block ${toggle ?'block' : ''} mx-auto translate-x-[-250px] duration-300`}>
